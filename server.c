...
void functii(char * comanda,void *arg)
{
    struct thData tdL;
	tdL = *((struct thData *)arg);
...
void start() 
{
  ...
  for(i=0;i<=16;i++)
    for(j=0;j<=16;j++)
        ...
        if(i==3 && j==3 || i==3 && j==4 ||i==4 && j==3 ||i==4 && j==4) //baza albastru
            strcpy(tabla[i][j],"AA");
        else
        if(i==3 && j==12 || i==3 && j==13 ||i==4 && j==12 ||i==4 && j==13) //baza rosu
             strcpy(tabla[i][j],"R ");
        else
        if(i==12 && j==3 || i==12 && j==4 ||i==13 && j==3 ||i==13 && j==4) //baza galben
             strcpy(tabla[i][j],"G ");
        else
        if(i==12 && j==12 || i==12 && j==13 ||i==13 && j==12 ||i==13 && j==13) //baza verde
             strcpy(tabla[i][j],"V ");
		else
            if(i==2 && j==9)
            ...
            if(i==14 && j==7)
		  	...
		  	if(i==7 && j>=1 && j<=15 && j!=7 && j!=8 && j!=9)
				 strcpy(tabla[i][j],"* ");
		else
		  	if(i==9 && j>=1 && j<=15 && j!=7 && j!=8 && j!=9)
				strcpy(tabla[i][j],"* ");
		else
		  	if(j==7 && i>=1 && i<=15 && i!=7 && i!=8 && i!=9)
				strcpy(tabla[i][j],"* ");
		else
		  	if(j==9 && i>=1 && i<=15 && i!=7 && i!=8 && i!=9)
				strcpy(tabla[i][j],"* ");
		else 
		if(i==8 && j>=2 && j<=6)
			strcpy(tabla[i][j],"a ");
